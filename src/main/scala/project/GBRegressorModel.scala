...
object GBRegressorModel {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark = SparkSession.builder()
      ...
      .appName("Zillow Recomendation model - Gradient Regression model")
      .getOrCreate()
 ...
 */
    val dtParamMaps = new ParamGridBuilder()
      .addGrid(gbt.maxIter, Array(3, 5, 7))
      .build()
 ...
 */
    ...
    val treeModel = cvModel.bestModel.asInstanceOf[org.apache.spark.ml.PipelineModel]
      .stages(1).asInstanceOf[GBTRegressionModel]
    println("Learned RF Regressor model:\n" + treeModel.toDebugString)
